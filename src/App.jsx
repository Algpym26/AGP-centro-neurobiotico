...
export default function App() {
  ...
  return <>
    ...
    <footer><img src={asset('agp-logo.jpeg')} alt="AGP Centro Neurobiótico" /><div><strong>AGP Centro Neurobiótico</strong><p>Alternative &amp; Holistic Health Services</p></div><p>La información de este sitio es educativa y de bienestar; no sustituye la evaluación, diagnóstico o tratamiento de un profesional médico.</p></footer>
