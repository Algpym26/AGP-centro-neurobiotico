...
export default function App() {
  ...
  return <>
    <header className="site-header">
      ...
      <nav className={`main-nav ${menuOpen ? 'open' : ''}`}><a href="#enfoque" onClick={closeMenu}>Nuestro enfoque</a><a href="#servicios" onClick={closeMenu}>Servicios</a><a href="#experiencia" onClick={closeMenu}>Tu experiencia</a><button className="nav-link" onClick={() => { setShowResources(true); closeMenu() }}>Recursos</button><a href="#pma" onClick={closeMenu}>PMA</a><WhatsAppButton className="nav-cta">Reservar cita</WhatsAppButton></nav>
    </header>
    <main>
